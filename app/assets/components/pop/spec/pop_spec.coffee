...
describe 'Pop', ->
  ...
  beforeEach ->
    ...
    @north_el = @html.find('#pop_north')
    @south_el = @html.find('#pop_south')
    @east_el = @html.find('#pop_east')
    @west_el = @html.find('#pop_west')
    @no_title_el = @html.find('#pop_no_title')
    @ext_el = @html.find('#pop_selector')
    @ext_content = @html.find('#pop_exterior_content')
    @override_el = @html.find('#overrides')
    @auto_el = @html.find('#auto_activated')
