...
# PUBLIC #
  ...
  remove: ->
    ...
    if utensil.Detect.hasTransition && @target.hasClass('in')
      @target.one(utensil.Detect.transition.end, => @removeTarget arguments...)
...
utensil.Bindable.register 'dismiss', utensil.Dismiss
