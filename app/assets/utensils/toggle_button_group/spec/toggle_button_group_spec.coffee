...
describe 'ToggleButtonGroup', ->
  ...
  beforeEach ->
    ...
    @radio = new utensils.ToggleButtonGroup(@radios_el)
    @check = new utensils.ToggleButtonGroup(@checks_el)
  ...
  describe '#constructor', ->
    it 'extends ToggleGroup', ->
      expect(@radio instanceof utensils.ToggleGroup).toEqual(true)

    it 'sets up a data object', ->
      expect(@radio.data).toBeDefined()

    it 'activates an element on initialization from a number', ->
      togglable = new utensils.ToggleButtonGroup(@radios_el, {activate: 1})
    ...
    it 'activates an element on initialization from an id', ->
      ...
      li.attr('id', 'blah')
      togglable = new utensils.ToggleButtonGroup(@radios_el, {activate: '#blah'})
